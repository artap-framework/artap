...
class WebPagesWriter:
    ...
    def table_to_fig_write_statically(self, table, link_column=None, page=None):
        ...
        with open(".." + os.sep + "artap_server" + os.sep + "static" + os.sep + "problem_fig_static.tp", 'r') as file:
            page = string.Template(file.read())
