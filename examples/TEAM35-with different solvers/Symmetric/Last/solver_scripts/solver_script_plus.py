...
geometry.add_edge(0.006039999999999992, 0.0, 0.005, 0.0, boundaries={'magnetic': 'n0'})
geometry.add_edge(0.14, 0.0, 0.0070399999999999924, 0.0, boundaries={'magnetic': 'n0'})
geometry.add_edge(0.0070399999999999924, 0.0, 0.006039999999999992, 0.0, boundaries={'magnetic': 'n0'})
...
geometry.add_edge(0.00604, 0.0015, 0.007009999999999999, 0.0015)
geometry.add_edge(0.007009999999999999, 0.0015, 0.00704, 0.0015)
geometry.add_edge(0.00704, 0.0015, 0.00704, 0.0)
geometry.add_edge(0.00604, 0.0, 0.00604, 0.0015)
geometry.add_edge(0.00601, 0.003, 0.00701, 0.003)
geometry.add_edge(0.00701, 0.003, 0.00701, 0.0015)
geometry.add_edge(0.0060399999999999985, 0.0015, 0.00601, 0.0015)
geometry.add_edge(0.00601, 0.0015, 0.00601, 0.003)
geometry.add_edge(0.00601, 0.0045000000000000005, 0.006109999999999998, 0.0045000000000000005)
geometry.add_edge(0.006109999999999998, 0.0045000000000000005, 0.007009999999999997, 0.0045000000000000005)
geometry.add_edge(0.00701, 0.0045000000000000005, 0.00701, 0.003)
geometry.add_edge(0.00601, 0.003, 0.00601, 0.0045000000000000005)
geometry.add_edge(0.0061100000000000034, 0.006, 0.007110000000000001, 0.006)
geometry.add_edge(0.007110000000000001, 0.006, 0.007110000000000001, 0.0045000000000000005)
geometry.add_edge(0.007110000000000001, 0.0045000000000000005, 0.007009999999999999, 0.0045000000000000005)
geometry.add_edge(0.006110000000000001, 0.0045000000000000005, 0.006110000000000001, 0.006)
geometry.add_edge(0.00165, 0.0075, 0.0025400000000000006, 0.0075)
geometry.add_edge(0.0025400000000000006, 0.0075, 0.00265, 0.0075)
geometry.add_edge(0.00265, 0.0075, 0.00265, 0.006)
geometry.add_edge(0.00265, 0.006, 0.00165, 0.006)
geometry.add_edge(0.00165, 0.006, 0.00165, 0.0075)
geometry.add_edge(0.0015400000000000001, 0.009000000000000001, 0.0025099999999999988, 0.009000000000000001)
geometry.add_edge(0.0025099999999999988, 0.009000000000000001, 0.00254, 0.009000000000000001)
geometry.add_edge(0.00254, 0.009000000000000001, 0.00254, 0.0075)
geometry.add_edge(0.0016499999999999996, 0.0075, 0.0015400000000000001, 0.0075)
geometry.add_edge(0.0015400000000000001, 0.0075, 0.0015400000000000001, 0.009000000000000001)
geometry.add_edge(0.00151, 0.0105, 0.0025099999999999996, 0.0105)
geometry.add_edge(0.0025099999999999996, 0.0105, 0.0025099999999999996, 0.009000000000000001)
geometry.add_edge(0.0015399999999999988, 0.009000000000000001, 0.00151, 0.009000000000000001)
geometry.add_edge(0.00151, 0.009000000000000001, 0.00151, 0.0105)
geometry.add_edge(0.00151, 0.012, 0.0024999999999999996, 0.012)
geometry.add_edge(0.0024999999999999996, 0.012, 0.0025099999999999996, 0.012)
geometry.add_edge(0.0025099999999999996, 0.012, 0.0025099999999999996, 0.0105)
geometry.add_edge(0.00151, 0.0105, 0.00151, 0.012)
geometry.add_edge(0.0015, 0.0135, 0.001509999999999998, 0.0135)
geometry.add_edge(0.001509999999999998, 0.0135, 0.0025, 0.0135)
geometry.add_edge(0.0025, 0.0135, 0.0025, 0.012)
geometry.add_edge(0.0015100000000000003, 0.012, 0.0015, 0.012)
geometry.add_edge(0.0015, 0.012, 0.0015, 0.0135)
geometry.add_edge(0.00151, 0.015, 0.0025099999999999996, 0.015)
geometry.add_edge(0.0025099999999999996, 0.015, 0.0025099999999999996, 0.0135)
geometry.add_edge(0.0025099999999999996, 0.0135, 0.0024999999999999996, 0.0135)
geometry.add_edge(0.00151, 0.0135, 0.00151, 0.015)

# BLOCK LABELS
geometry.add_label(0.00679, 0.00075, materials = {'magnetic' : 'J+'})
geometry.add_label(0.0067599999999999995, 0.0022500000000000003, materials = {'magnetic' : 'J+'})
geometry.add_label(0.0067599999999999995, 0.00375, materials = {'magnetic' : 'J+'})
geometry.add_label(0.006860000000000001, 0.00525, materials = {'magnetic' : 'J+'})
geometry.add_label(0.0024, 0.00675, materials = {'magnetic' : 'J+'})
geometry.add_label(0.00229, 0.00825, materials = {'magnetic' : 'J+'})
geometry.add_label(0.00226, 0.00975, materials = {'magnetic' : 'J+'})
geometry.add_label(0.00226, 0.01125, materials = {'magnetic' : 'J+'})
geometry.add_label(0.0022500000000000003, 0.012750000000000001, materials = {'magnetic' : 'J+'})
geometry.add_label(0.00226, 0.01425, materials = {'magnetic' : 'J+'})
...
f = open(r"/home/gadokrisztian/work/adze-modeler/applications/Cooking_with_adze_modeler/Symmetric/snapshots/alma_plus/agros_solution.csv", "w")
