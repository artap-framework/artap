...
geometry.add_edge(0.006539999999999992, 0.0, 0.005539999999999992, 0.0, boundaries={'magnetic': 'n0'})
geometry.add_edge(0.005539999999999992, 0.0, 0.005, 0.0, boundaries={'magnetic': 'n0'})
geometry.add_edge(0.14, 0.0, 0.006539999999999992, 0.0, boundaries={'magnetic': 'n0'})
...
geometry.add_edge(0.00554, 0.0015, 0.006509999999999999, 0.0015)
geometry.add_edge(0.006509999999999999, 0.0015, 0.00654, 0.0015)
geometry.add_edge(0.00654, 0.0015, 0.00654, 0.0)
geometry.add_edge(0.00554, 0.0, 0.00554, 0.0015)
geometry.add_edge(0.00551, 0.003, 0.00651, 0.003)
geometry.add_edge(0.00651, 0.003, 0.00651, 0.0015)
geometry.add_edge(0.005539999999999998, 0.0015, 0.00551, 0.0015)
geometry.add_edge(0.00551, 0.0015, 0.00551, 0.003)
geometry.add_edge(0.00551, 0.0045000000000000005, 0.005609999999999999, 0.0045000000000000005)
geometry.add_edge(0.005609999999999999, 0.0045000000000000005, 0.00651, 0.0045000000000000005)
geometry.add_edge(0.00651, 0.0045000000000000005, 0.00651, 0.003)
geometry.add_edge(0.00551, 0.003, 0.00551, 0.0045000000000000005)
geometry.add_edge(0.005610000000000003, 0.006, 0.00661, 0.006)
geometry.add_edge(0.00661, 0.006, 0.00661, 0.0045000000000000005)
geometry.add_edge(0.00661, 0.0045000000000000005, 0.006509999999999999, 0.0045000000000000005)
geometry.add_edge(0.00561, 0.0045000000000000005, 0.00561, 0.006)
geometry.add_edge(0.0011499999999999993, 0.0075, 0.0020400000000000006, 0.0075)
geometry.add_edge(0.0020400000000000006, 0.0075, 0.00215, 0.0075)
geometry.add_edge(0.00215, 0.0075, 0.00215, 0.006)
geometry.add_edge(0.00215, 0.006, 0.0011499999999999993, 0.006)
geometry.add_edge(0.00115, 0.006, 0.00115, 0.0075)
geometry.add_edge(0.0010400000000000001, 0.009000000000000001, 0.0020099999999999988, 0.009000000000000001)
geometry.add_edge(0.0020099999999999988, 0.009000000000000001, 0.00204, 0.009000000000000001)
geometry.add_edge(0.00204, 0.009000000000000001, 0.00204, 0.0075)
geometry.add_edge(0.00115, 0.0075, 0.0010400000000000001, 0.0075)
geometry.add_edge(0.0010400000000000001, 0.0075, 0.0010400000000000001, 0.009000000000000001)
geometry.add_edge(0.00101, 0.0105, 0.0020099999999999996, 0.0105)
geometry.add_edge(0.0020099999999999996, 0.0105, 0.0020099999999999996, 0.009000000000000001)
geometry.add_edge(0.0010399999999999988, 0.009000000000000001, 0.00101, 0.009000000000000001)
geometry.add_edge(0.00101, 0.009000000000000001, 0.00101, 0.0105)
geometry.add_edge(0.00101, 0.012, 0.0019999999999999996, 0.012)
geometry.add_edge(0.0019999999999999996, 0.012, 0.0020099999999999996, 0.012)
geometry.add_edge(0.0020099999999999996, 0.012, 0.0020099999999999996, 0.0105)
geometry.add_edge(0.00101, 0.0105, 0.00101, 0.012)
geometry.add_edge(0.001, 0.0135, 0.0010100000000000005, 0.0135)
geometry.add_edge(0.0010100000000000005, 0.0135, 0.002, 0.0135)
geometry.add_edge(0.002, 0.0135, 0.002, 0.012)
geometry.add_edge(0.0010100000000000003, 0.012, 0.001, 0.012)
geometry.add_edge(0.001, 0.012, 0.001, 0.0135)
...
geometry.add_edge(0.0020099999999999996, 0.0135, 0.001999999999999999, 0.0135)
geometry.add_edge(0.00101, 0.0135, 0.00101, 0.015)

# BLOCK LABELS
geometry.add_label(0.0062900000000000005, 0.00075, materials = {'magnetic' : 'J+'})
geometry.add_label(0.00626, 0.0022500000000000003, materials = {'magnetic' : 'J+'})
geometry.add_label(0.00626, 0.00375, materials = {'magnetic' : 'J+'})
geometry.add_label(0.00636, 0.00525, materials = {'magnetic' : 'J+'})
geometry.add_label(0.0019, 0.00675, materials = {'magnetic' : 'J+'})
geometry.add_label(0.0017900000000000001, 0.00825, materials = {'magnetic' : 'J+'})
geometry.add_label(0.00176, 0.00975, materials = {'magnetic' : 'J+'})
geometry.add_label(0.00176, 0.01125, materials = {'magnetic' : 'J+'})
geometry.add_label(0.00175, 0.012750000000000001, materials = {'magnetic' : 'J+'})
...
f = open(r"/home/gadokrisztian/work/adze-modeler/applications/Cooking_with_adze_modeler/Symmetric/snapshots/alma_0/agros_solution.csv", "w")
