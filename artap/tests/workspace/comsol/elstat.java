...
public class elstat {
	...
	public static Model run() throws IOException{		
		...
		FileReader input = new FileReader("./workspace/comsol/parameters.txt");
		...
		model.modelPath("./workspace/comsol/");
		...
		model.result().export("tbl1").set("filename", "./workspace/comsol/max.txt");
